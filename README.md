...
#
  ...
  :pencil2: 개요                                  
  학생들은 학교 홈페이지, e-class System, 종합정보시스템 등 필요한 웹페이지에 각각 접속해서 이용해야 합니다. <br>
  이러한 불편함을 해소하기 위하여 하나로 통합된 학사정보 시스템 구축.<br> 학생들의 편리한 홈페이지 사용이 가능하도록 프로그램을 개발하게 되었습니다.
...
![](./images/subject.JPG)
<br>
**수강하기 버튼을 누르면, 1. 이미 수강중인 경우 2. 18학점이 초과되는 경우 3. 해당 시간에 다른 강의를 수강중인 경우에 
해당하지 않을 시 수강이 완료되고 신청과목 목록에 해당 과목이 출력됩니다.
Ajax를 사용하여, 페이지 전환없이 바로 수강신청과 수강취소를 가능하게 하였습니다.**

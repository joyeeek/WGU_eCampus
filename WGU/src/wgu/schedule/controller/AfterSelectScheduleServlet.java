...
/**
 * Servlet implementation class AfterSelectScheduleServlet
 */
@WebServlet("/afterSelectSchedule.sc")
public class AfterSelectScheduleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AfterSelectScheduleServlet() {
        super();

...
/**
 * Servlet implementation class NowSelectScheduleServlet
 */
@WebServlet("/nowSelectSchedule.sc")
public class NowSelectScheduleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public NowSelectScheduleServlet() {
        super();

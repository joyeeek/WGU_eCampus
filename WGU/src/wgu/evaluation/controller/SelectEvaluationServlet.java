 ...
 */
@WebServlet("/selectEvaluation.ev")
public class SelectEvaluationServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(memberNo.charAt(0) == 'P') {
			...
			request.getRequestDispatcher("WEB-INF/views/evaluation/proEvaluation.jsp").forward(request, response);
			...
			request.setAttribute("msg", "평가 확인 접속에 실패하였습니다.");
